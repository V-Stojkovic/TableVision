...
TO_HOVER = ctk.CTkImage(Image.open(PATH.joinpath('to_hover.png')),size=(130,130))
TO_CLICKED = ctk.CTkImage(Image.open(PATH.joinpath('to_clicked.png')),size=(130,130))
CAMERA_ICON = ctk.CTkImage(Image.open(PATH.joinpath('camera_icon.png')),size=(200,200))
